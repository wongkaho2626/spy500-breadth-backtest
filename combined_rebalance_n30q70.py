...
Rebalancing     : None — existing positions are NOT liquidated on contribution dates
Signals:
...
Exports (in same directory):
  combined_rebalance_n30q70_metrics.csv
  combined_rebalance_n30q70_combined.csv   — combined portfolio trade log
  combined_rebalance_n30q70_ndxa.csv       — NDX Top-1 leg trade log
  combined_rebalance_n30q70_qqqb.csv       — QQQ-B (NDX proxy) leg trade log
"""
import warnings
...
def export_csvs(
    ...
    prefix = DATA_DIR / "combined_rebalance_n30q70"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Combined NDX-Top1 30% / QQQ 70% backtest")
